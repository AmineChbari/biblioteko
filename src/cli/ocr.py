...
class OCRExtractor:
    ...
    # --- Gemini request ---
    def _extract_gemini(self, image_data: bytes) -> str:
    ...
    # --- Mistral request ---
    def _extract_mistral(self, image_data: bytes) -> str:
        try:
    ...
    def extract_text(self, image_data: bytes) -> str:
        if self.engine == "gemini":
            return self._extract_gemini(image_data)
        elif self.engine == "mistral":
            return self._extract_mistral(image_data)
        else:
    ...
    def process(self, file_path: str, limit: int = None):
        ...
        if ext in [".jpg", ".jpeg", ".png"]:
            ...
            for i in range(limit):
                ...
                text = self.extractor.extract_text(pix.tobytes("jpeg"))
